								...
								<div className="hidden items-center gap-2 md:flex">
									...
									{!loading && user ? (
										<div className="flex items-center gap-2">
											{/* Avatar do usuário */}
											{user.avatarUrl ? (
												<img src={user.avatarUrl} alt="Avatar" className="w-9 h-9 rounded-full border-2 border-blue-400 object-cover" />
											) : (
												<div className="w-9 h-9 rounded-full bg-blue-200 flex items-center justify-center border-2 border-blue-400 text-blue-700 font-bold text-lg">
